...
public class C_Mapping {
	...
	public void method1() {
		...
		double avg = students.stream()
			    .mapToInt(student -> student.getMath()) // mapToInt 사용 -> IntStream
				.average() // OptionalDouble 형태
				.getAsDouble(); // double로 변경
...
//			.forEach(str -> System.out.println(str));
			.forEach(System.out::println); // 동일하게 출력됨
	}
	
	/* asDoubleStream(), asLongStream(), boxed()
	 * - asDoubleStream : InstStream, LongStream을 DoubleStream으로 변환
