...
/* java.time 패키지
 * - Date와 Calendar의 단점을 개선한 새로운 클래스들을 제공 (JDK 1.8 버전)
...
public class B_Time {
	...
	public void method2() {
		...
		System.out.println("minutes : "+du.toMinutesPart()); // toMinutes는 시간이 포함돼서 계산됨
		System.out.println("seconds : "+du.toSecondsPart());
	...
	public void method3() {
		...
		try {
			...
			long dDay = date.until(today, ChronoUnit.DAYS);
