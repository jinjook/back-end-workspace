...
public class Car {
	 ...
	 * [ ] default : 명시하지 않음. 같은 패키지 내에서만 접근 가능
	 ...
	 * - 반환형이 존재하지 않음. 만약 반환형을 쓰게 되면 method로 인식됨
	 * 
	 * 기본 생성자(default constructor)
	 * - 매개변수가 없는 생성자
	 * - 클래스에 생성자가 하나도 없으면 컴파일러가 기본 생성자르 추가
	...
	public Car(String color, String gearType, int door) {
		...
		this.door = door;
		// 클래스와 매개변수 이름이 같을 때(= 클래스를 못 찾는경우)this.를 붙여주면 됨
	}
