...
public class Application {
	 ...
	 * - 파일 이름은 반드시 선언된 클래스 이름과 같도록 할 것
	...
	public static void main(String[] args) {
		 ...
		 * */
		System.out.println("TV 상태 : " + tv.power); // false : TV가 꺼진 상태 (boolean-상태 확인)
		
		tv.power(); // 메서드 호출 -> () 필요 / 호출하는 순간 !power 구현 됨
		System.out.println("TV 상태 : " + tv.power); // true : TV가 켜짐
