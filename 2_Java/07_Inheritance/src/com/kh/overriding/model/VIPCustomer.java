...
public class VIPCustomer extends Customer {
	...
	/* 오버라이딩의 조건
	 * - 부모 클래스의 메서드명, 매개변수, 리턴타입 모두 동일해야함
	 * - 접근제어자를 좁은 범위로 변경할 수 없음 (가장 좁은 범위 : private < default < protected < public)
	 * 	-> 부모 클래스 메서드가 protected 라면, 범위가 같거나 넓은 protected 나 public 으로만 변경 가능
	 * 
	 * @Override 어노테이션
	 * - 굳이 명시 안해줘도 오버라이딩 가능
	 * - 어노테이션을 붙이는 이유 
