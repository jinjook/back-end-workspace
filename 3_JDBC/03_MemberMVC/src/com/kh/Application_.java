...
import com.kh.controller.MemberController_;
import com.kh.model.Member_;

public class Application_ {
	
	private Scanner sc = new Scanner(System.in);
	private MemberController_ mc = MemberController_.getInstance();
	...
	public void signUp() throws SQLException {
		...
		if(mc.signUp(new Member_(id, password, name))) {
			// true : "성공적으로 회원가입 완료하였습니다." 출력
			System.out.println("성공적으로 회원가입 완료하였습니다.");
		} else {
			// false : "중복된 아이디입니다. 다시 입력해주세요." 출력
